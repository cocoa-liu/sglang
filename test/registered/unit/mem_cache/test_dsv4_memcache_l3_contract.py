...
def test_device_transports_lazy_init_is_limited_to_dsv4_pool_groups():
    ...
    assert AscendMemcacheStore._should_lazy_init(dsv4_group, "device_sdma", True)
    assert AscendMemcacheStore._should_lazy_init(dsv4_group, "device_rdma", True)
    ...
    assert not AscendMemcacheStore._should_lazy_init(dsv4_group, "device_rdma", False)
